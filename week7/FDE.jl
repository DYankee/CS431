...
# This allows for easy parallelization when additional threads are available because each thread is free to access 
# the data available to it without working about race conditions. 